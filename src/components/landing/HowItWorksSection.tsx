import dashboardDeskImg from "@/assets/dashboard-desk.jpg";
    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="rounded-3xl overflow-hidden shadow-xl border border-border/50">
          <img
            src={dashboardDeskImg}
            alt="Tablet showing a care facility scheduling dashboard on a clean modern desk"
